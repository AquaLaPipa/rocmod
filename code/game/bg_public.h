...
#define ROCMOD_STRING		"ROCmod 2.1c"
#define ROCMOD_VERSION		"2.1c"
#define ROCMOD_VER			2012			// 2012 = 2.01.2 = 2.1c
#define ROCMOD_DATE			"January 20, 2006"
...
#define JUMP_SHOTGUN_ACCURACY_MODIFIER	5.0f
#define JUMP_SNIPER_ACCURACY_MODIFIER	300.0f
#define RUN_SNIPER_ACCURACY_MODIFIER	150.0f
...
qboolean	BG_RelatedGametype		( int gametype, const char* name );
